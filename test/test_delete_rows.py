...
class TestDeleteRows(unittest.TestCase):
    ...
    mock_service = MockDeleteRows(**configs)
    ...
    def test_success(self, mock_post):
        ...
        resp = delete_rows(self.server_context, self.schema, self.query, '{id:"1234"}')
    ...
    def test_server_error(self, mock_post):
        with self.assertRaises(RequestError):
            ...
            delete_rows(self.server_context, self.schema, self.query, '{id:"1234"}')
