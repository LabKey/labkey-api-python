...
class TestUpdateRows(unittest.TestCase):
    ...
    mock_service = MockUpdateRows(**configs)
    ...
    def test_success(self, mock_post):
        ...
        resp = update_rows(self.server_context, self.schema, self.query, '{id:"1234"}')
    ...
    def test_server_error(self, mock_post):
        with self.assertRaises(RequestError):
            ...
            update_rows(self.server_context, self.schema, self.query, '{id:"1234"}')
